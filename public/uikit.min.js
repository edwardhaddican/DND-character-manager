...
!(function(t, e) {
  ...
  function V(t) {
    return _(t)
      ...
      : N(t)
        ? m.slice.call(t)
        : k(t) ? t.map(W).filter(Boolean) : C(t) ? t.toArray() : []
  }
  function R(t) {
    return E(t)
      ? t
      : (t = W(t)) ? (A(t) ? t : t.ownerDocument).defaultView : window
  }
  function q(t) {
    return k(t)
      ? t
  ...
  var rt = {
    ratio: function(t, e, i) {
      ...
      return (
        ((n = {})[r] = t[e] ? Math.round(i * t[r] / t[e]) : t[r]), (n[e] = i), n
      )
    },
  ...
  function me(t, e, i, n) {
    ...
    return (
      (t = P(t)
        ? F(t)
        : 'next' === t ? i + 1 : 'previous' === t ? i - 1 : pe(e, t)),
      ...
      he(function() {
        if (o.state !== ae)
          for (; o.deferred.length; ) {
            ...
            try {
              0 === o.state
                ? $(e) ? n(e.call(void 0, o.value)) : n(o.value)
                : 1 === o.state &&
  ...
  function wi(t, e, i) {
    return (
      ...
      P(t)
        ...
        : u(t, 'vh')
          ? bi(ci(R(i)), t)
          : u(t, 'vw') ? bi(li(R(i)), t) : u(t, '%') ? bi(ai(i)[e], t) : j(t)
    )
  }
  function bi(t, e) {
    return t * j(e) / 100
  ...
  Ti.prototype = {
    ...
    init: function() {
      ...
      ;(this.positions = []),
        ...
        (this.interval = setInterval(function() {
          e &&
            (t.positions.push(e), 5 < t.positions.length && t.positions.shift())
        }, 50))
    },
    cancel: function() {
    ...
    movesTo: function(t) {
      ...
      return (
        !nt(a, i) &&
        [[{x: e, y: r}, {x: n, y: o}], [{x: e, y: o}, {x: n, y: r}]].some(
          function(t) {
            var e = (function(t, e) {
              var i = t[0],
                n = i.x,
  ...
  function an(t, e) {
    return t === Boolean
      ? L(e)
      : t === Number ? F(e) : 'list' === t ? q(e) : t ? t(e) : e
  }
      ...
      computed: {
        icon: function(t, e) {
          ...
          return Oe(e, 'uk-search-icon') && qt(e, '.uk-search-large').length
            ? 'search-large'
            : qt(e, '.uk-search-navbar').length ? 'search-navbar' : i
        }
      }
    },
    Wn = {
  ...
  var xr = {
    ...
    kr = {
      ...
      update: {
        read: function() {
          return (
            !(!b(this.mode, 'media') || !this.media) && {match: this.matchMedia}
          )
        },
        write: function(t) {
          var e = t.match,
            ...
            se
              .all(
                r
                  ...
                  .concat(
                    e !== s &&
                      Ze.start(this.target, {height: s}, this.animation, 'ease')
                  )
              )
              .then(function() {
                r.forEach(function(t, e) {
          ...
          return {
            ...
            translate: function(t) {
              ...
              Ve(
                ...
                r &&
                  ((t = tt(t, -1, 1)),
                  ro(this.getItemIn(), 'itemtranslatein', {percent: t, dir: o}),
  ...
  var co,
    ...
    fo = G({}, Dr, {
      ...
      pull: {
        show: function(t) {
          return t < 0
            ? [{transform: Pr(30), zIndex: -1}, {transform: Pr(), zIndex: 0}]
            : [{transform: Pr(-100), zIndex: 0}, {transform: Pr(), zIndex: -1}]
        },
      ...
      methods: {
        ...
        insert: function(i, n) {
          ...
          function t() {
            ...
            n
              ? (!Rt(i, r.target) ||
                ((e = n), (t = i).parentNode === e.parentNode && pe(t) > pe(e))
                  ? be
                  : xe)(n, i)
              : we(r.target, i)
          }
  ...
  var go = [],
    vo = {
      ...
      events: (((lo = {focus: 'show', blur: 'hide'})[vt + ' ' + wt] = function(
        t
      ) {
